              ...
              <v-card-text>
                <v-form ref="form" lazy-validation>
                  <v-container>
                    ...
                    <v-text-field
                    v-model="subscription.sub_Name"
                    label="Name"
                    required
                    />
                    <v-text-field
                    v-model="subscription.sub_Description"
                    label="Description"
                    required
                    />
                    <v-text-field
                    v-model="subscription.sub_Price"
                    label="Price"
                    required
                    type="number"
                    />
                    ...
                    <v-text-field
                    v-model="subscription.acquired_date"
                    label="Acquired Date"
                    required
                    type="date"
                    />
